...
```bash
# Clone
git clone https://github.com/m451h/Equity-Oriented-Screening-Allocation-Model-Copy.git
cd Equity-Oriented-Screening-Allocation-Model-Copy
...
@software{equity_screening_2026,
  ...
  year   = {2026},
  url    = {https://github.com/m451h/Equity-Oriented-Screening-Allocation-Model-Copy}
}
```
